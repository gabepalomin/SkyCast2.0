...
router.get("/:id", async (req, res) => {
	...
	axios.get('http://api.aviationstack.com/v1/flights?access_key=b39d1984c7900258091947bda6cbbdb9&flight_iata=' + input.id)
		.then(response => {
			...
			const resObject = {depIata, arrIata, depDate, depTime, arrTime, arrDate, aircraftCode, carrierCode, flightNumber, gate};
